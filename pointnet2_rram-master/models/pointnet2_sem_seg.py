...
class get_model(nn.Module):
    def __init__(self, num_classes, c_prune_rate=4):
        ...
        self.sa2 = PointNetSetAbstraction(256, 0.2, 32, int(64/c_prune_rate) + 3, mlp2, False)
        self.sa3 = PointNetSetAbstraction(64, 0.4, 32, int(128/c_prune_rate) + 3, mlp3, False)
        self.sa4 = PointNetSetAbstraction(16, 0.8, 32, int(256/c_prune_rate) + 3, mlp4, False)
